...
export default function AuthPage() {
  ...
  <div className="border text-[18px] md:text-[24px] w-[140px] md:w-[168px] h-7 md:h-[34px] rounded-4xl flex justify-center items-center mb-5">Achieve</div>
    ...
    <div className="w-full rounded-t-4xl bg-[#091743] text-white flex flex-col items-center pt-[5vh] px-4 md:px-8">
        ...
        <button onClick={() => setIsOpen1(prev => !prev)} className={`w-full md:w-[85%] bg-white rounded-3xl mt-6 md:mt-10 text-[#091743] px-6 md:px-10 overflow-hidden`}>
        ...
        <button onClick={() => setIsOpen2(prev => !prev)} className={`w-full md:w-[85%] bg-white rounded-3xl mt-6 md:mt-10 text-[#091743] px-6 md:px-10 mb-10 overflow-hidden`}>
          <div className="min-h-[60px] md:h-[77px] flex justify-between items-center gap-4 md:gap-10 py-3 md:py-0">
