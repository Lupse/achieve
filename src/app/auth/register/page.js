    ...
    <div className="flex flex-col lg:flex-row justify-center gap-8 lg:gap-[10vw] xl:gap-[18vw] mt-6 md:mt-[30px] mx-4 md:mx-8 lg:mx-[45px] pb-10">
        ...
        <div className="w-full lg:w-[420px] xl:w-[482px] lg:mt-10 flex flex-col">
            <div className="text-center">
                <p className="font-semibold text-[24px] md:text-[28px]">Daftar Akun</p>
                <p className="text-[16px] md:text-[18px] mt-3 px-2">Mulai langkah bangun karir di masa depan bersama Achieve</p>
            ...
            <SecondaryButton onClick={() => alert("Ditekan!")}> 
                ...
                <span className="text-[14px] md:text-[16px]">Daftar dengan akun Linkedin</span>
            </SecondaryButton>
            <div className="text-center">
                <p className="text-[16px] md:text-[18px] mt-8 md:mt-10">Sudah punya akun? <Link href="/auth/login" className="hover:text-[#091743] text-[#1A43C0]">Masuk Sekarang</Link></p>
            </div>
        </div>
    </div>
    </div>
